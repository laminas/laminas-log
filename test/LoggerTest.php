...
class LoggerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLogExtraArrayKeyWithNonArrayValue()
    {
        ...
        $this->assertInstanceOf('Laminas\Log\Logger', $logger->info('Hi', array('extra' => '')));
        fclose($stream);
    }
    ...
    public function testRegisterFatalShutdownFunction()
    {
        ...
        register_shutdown_function(function () use ($writer, $self) {
            $self->assertEquals($writer->events[0]['message'], 'Call to undefined method LaminasTest\Log\LoggerTest::callToNonExistingMethod()');
        });
